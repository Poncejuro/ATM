...
public abstract class  Principal_Functions {
        ...
        do {
            do {
                ...
                if ((selection >= 1 && selection <= 5) || selection ==9) {
                    ...
                    flagExit=++flagExit;
                    if (flagExit==3){
                        System.out.println("Se alcanczó el límite de intentos, hasta luego.");
                        System.out.println(flagExit);
                        System.out.println("-----------------------------------------------");
                        flag = 2;
                    }
                }
            } while (flag == 0);
            // este método ejecuta las opcion introducida por el usuario, llamando a otras classes
            switch (selection) {
                case 1:
                    Principal_Functions messageW = new Withdrawal_Function();
                    messageW.Transactions();
                    break;
                case 2:
                    Principal_Functions messageD = new Deposit_function();
                    messageD.Transactions();
                    break;
                case 3:
                    Principal_Functions messageC = new Consult_Function();
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Principal_Functions messageM = new MovementsFunction();
    ...
    public LinkedHashMap <Integer, ListObj> getFinalList(){return linkedHashMap;}
    public void Withdrawal(){withdrawal = input.nextDouble();}
    public void Donations(){balance = balance-200; }
    public void Deposit(){deposit = input.nextDouble();}
    public double getBalance(){ return balance;}
    public void setBalance(double balance){Principal_Functions.balance = balance;}
    //al final se crea un método sin constructor para heredarla cuando sea necesario
    //la razón de esto, es separar el menu general de la lógica contenida en cada opción
